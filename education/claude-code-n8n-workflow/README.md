...
삼삼엠투 마케팅팀 사내 실습 워크숍 발표 자료 (HTML 슬라이드, 16:9, 총 28장)
강사: 마케팅팀 박현웅
...
- **F** 전체화면 · **O**(또는 ESC로 닫기) 전체 슬라이드 개요 · **P** 발표자 보기(현재+다음 슬라이드+타이머, 별도 창)
- `Home` 처음으로 · `End` 마지막으로
- 주소창의 `#번호`로 특정 슬라이드 바로가기 (예: `index.html#14`)

> 발표자 보기는 같은 브라우저에서 새 창으로 열립니다. 한 화면엔 발표자 보기, 빔프로젝터(확장 화면)엔 일반 보기를 띄우면 두 창이 자동으로 동기화됩니다.
